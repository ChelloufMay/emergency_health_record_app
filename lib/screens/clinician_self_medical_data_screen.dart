...
class ClinicianSelfMedicalDataScreen extends StatefulWidget {
  const ClinicianSelfMedicalDataScreen({super.key});

  @override
  State<ClinicianSelfMedicalDataScreen> createState() =>
      _ClinicianSelfMedicalDataScreenState();
}

class _ClinicianSelfMedicalDataScreenState
    extends State<ClinicianSelfMedicalDataScreen> {
  final PatientService _patientService = PatientService();

  bool _loading = true;
  String? _error;
  String? _patientId;
  String _roleLabel = 'clinician';
  ...
  Future<void> _loadIdentity() async {
    ...
    try {
      ...
      setState(() {
        ...
        _roleLabel = (role == null || role.isEmpty) ? 'clinician' : role;
        _loading = false;
      });
    } catch (e) {
      if (!mounted) return;
