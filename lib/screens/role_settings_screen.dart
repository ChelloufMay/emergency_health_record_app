...
class RoleSettingsScreen extends StatefulWidget {
  ...
  final bool showMedicalSummary;
  final bool showQr;
  final bool showCaregivers;
  ...
  const RoleSettingsScreen({
    ...
    required this.showMedicalSummary,
    required this.showQr,
    required this.showCaregivers,
...
class _RoleSettingsScreenState extends State<RoleSettingsScreen> {
  ...
  // CHANGED: recovery email action removed on purpose.
  // Password recovery stays in the login flow only.
  ...
  Future<void> _requestAccountDeletion() async {
    ...
    try {
      ...
      _showSnack('Could not send deletion request: $e', error: true);
    } finally {
      reasonController.dispose();
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final isPatient =
        widget.showMedicalSummary ||
        widget.showQr ||
        widget.showCaregivers ||
                    ...
                    child: Column(
                      children: [
                        _tile(
                          icon: Icons.history_outlined,
                          title: 'Audit log',
                          subtitle: 'See actions performed on your account',
                          onTap: widget.showAuditLog
                              ? () => Navigator.pushNamed(context, '/audit_log')
                              : null,
                        ),
                      ],
                ...
                Card(
                  ...
                  child: Column(
                    children: [
                      ...
                      if (isPatient) ...[
                        _divider(),
                        // CHANGED: keep the patient layout, but remove recovery email.
                        _tile(
                    ...
                    children: [
                      ...
                      if (widget.showDeleteAccount) ...[
                        ...
                        _tile(
                          ...
                          subtitle:
                              'Send a deletion request to the administrator',
                          iconColor: cs.error,
                          titleColor: cs.error,
