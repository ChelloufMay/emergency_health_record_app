...
class CaregiverSelfMedicalDataScreen extends StatefulWidget {
  const CaregiverSelfMedicalDataScreen({super.key});

  @override
  State<CaregiverSelfMedicalDataScreen> createState() =>
      _CaregiverSelfMedicalDataScreenState();
}

class _CaregiverSelfMedicalDataScreenState
    extends State<CaregiverSelfMedicalDataScreen> {
  final PatientService _patientService = PatientService();

  bool _loading = true;
  String? _error;
  String? _patientId;
  String _roleLabel = 'caregiver';
  ...
  Future<void> _loadIdentity() async {
    ...
    try {
      ...
      setState(() {
        ...
        _roleLabel = (role == null || role.isEmpty) ? 'caregiver' : role;
        _loading = false;
      });
    } catch (e) {
      if (!mounted) return;
